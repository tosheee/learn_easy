...
class Admin::LessonsControllerTest < ActionController::TestCase
  ...
  test "should create admin_lesson" do
    assert_difference('Admin::Lesson.count') do
      post :create, admin_lesson: { conversation: @admin_lesson.conversation, view: @admin_lesson.view, words: @admin_lesson.words }
    end
  ...
  test "should update admin_lesson" do
    patch :update, id: @admin_lesson, admin_lesson: { conversation: @admin_lesson.conversation, view: @admin_lesson.view, words: @admin_lesson.words }
    assert_redirected_to admin_lesson_path(assigns(:admin_lesson))
  end
